...
def set_audio_quality():
    global audio_quality, fs  # Use global keyword to modify global variables
    if admin_mode:
...
def login_to_admin_mode():
    global admin_mode, user_authenticated  # Use global keyword to modify global variables
...
def delete_file(folder_path):
    path = input("Enter the File Name Along With Format Which Is To Be deleted : ")
